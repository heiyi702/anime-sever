 ...
 * test 返回文件流
 */
// router.post('/api/downFile', function(req, res) {
//     // res.sendFile(`${_dirname}/html/index.html`)
//     // console.log('=================== 下载 ===================', req)
//     // let fName = req.body.name
//     // res.sendFile(`${ __dirname }/myFiel/${fName}`)
//     // -------------------
//     let fName = req.body.name
//     const filePath = path.resolve(__dirname, `./myFiel/${fName}`);
...
router.post('/api/downFile', (req, res) => {

    // 假设我们的word文档文件就存放在这个doc目录里面
    // let docxUrl = './myFiel/1.docx'
    let fName = req.body.name
    let docxUrl = path.resolve(__dirname, `./myFiel/${fName}`);
